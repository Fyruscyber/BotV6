...
*/
const XPTN = 'XONTOL BOT'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/IndraFajri64'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+6285226087964'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi'; // DI GANTI AUTO EROR
const youtube = 'Fyrus'; // DI GANTI AUTO EROR
//
...
conn.sendMessage(id, 'Owner BOTLENT wa.me/+6285226087964' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285226087964* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
